                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('pengaturan.app') }}"  aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Aplikasi</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('pengaturan.mqtt') }}"  aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>MQTT Broker</a>
                            </li>
                        </ul>
                    </div>
                </nav>
